...
namespace Buzzle.JobsManager.Views
{
    public partial class AddEditJobView : BuzzleGlobalView
    {
        ...
        private List<ItemType> _allItemTypes;
        ...
        private void UpDateOrSetJobCreator()
        {
            ...
            {
                textEdit_CreatedBy.Text = _currentJob.Creator.FullName;
            }
        }
        ...
        {
            return _dataManager.AddItemType(new ItemType()
            {
        ...
        {
            return
                BuzzleValidator.CheckEmptiness(textEdit_CustomerName.Text, "Customer Name") &&
                BuzzleValidator.CheckEmptiness(calcEdit_PhoneNumber.Text, "Phone Number") &&
                BuzzleValidator.CheckEmptiness(comboEdit_ItemType.Text, "Item type") &&
                BuzzleValidator.CheckEmptiness(comboEdit_FaultType.Text, "Fault type");
        }
